...
if($input["action"] === 'edit')
{
 $query = "
 UPDATE property 
 SET p_type = '".$p_type."', bedroom = '".$bedroom."', bathroom = '".$bathroom."', size = '".$size."', 
 b_type = '".$b_type."', l_type = '".$l_type."', address1 = '".$address1."', address2 = '".$address2."', 
 city = '".$city."', parish = '".$parish."', price = '".$price."'
